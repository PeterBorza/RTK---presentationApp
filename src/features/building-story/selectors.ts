...
export const activeSelector = createSelector(liftsState, lifts => lifts.map(lift => lift.isActive));

export const topLevelSelector = createSelector(levelsState, levels => levels - 1);
